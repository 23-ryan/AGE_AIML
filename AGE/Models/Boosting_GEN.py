...
class Boosting_GEN:
    ...
    def fit(self, n_estimators, backbone_output=128):
        """
        ...
        """
        features_path_X = f'Saved_Models/Features/vgg_transfer_gender_{backbone_output}_X.keras.npy'
        X = np.load(features_path_X)

        features_path_Y = f'Saved_Models/Features/vgg_transfer_gender_{backbone_output}_Y.keras.npy'
        ...
        for t in range(n_estimators):
            ...
            self.learner_weights[t].assign(tf.math.log((1 - error) / error) / 2)
